...
/*
    ...
    $(".theme-settings input").on("ifClicked",function(){
        ...
        if(input.attr("name") != 'st_layout_boxed'){
            ...
            if(!input.prop("checked")){
                ...
                setUserTheme(input.attr("name"), 1);
            }else{            
                theme_settings[input.attr("name")] = 0;
                setUserTheme(input.attr("name"), 0);
            }
            
        }else{
            theme_settings[input.attr("name")] = input.val();

            setUserTheme(input.attr("name"), input.val());
        }
    ...
    $(".ts-themes a[data-theme]").click(function(){
        ...
        setUserTheme("ThemeName", $(this).data("theme"));
        return false;
    });
    /* END Change Theme */ 
    /* Change Wallpaper */
    $(".ts-themes a[data-wall]").click(function(){
        ...
        setUserTheme("BackgroundImage", $(this).data("wall"));
        return false;
    });
